...
sampleRecord = {'sampleName': 'NULL', 'tagID': 'NULL', 'laneID': 'NULL', 'tagSequence': 'NULL', 'analysisID': 'NULL',
                'adaptorSequence': 'NULL'}
    ...
    for l in range(0, len(expts)):
        ...
        for m in range(0, len(i.seqProjs)):
            ...
            for n in range(0, len(i.seqProjs[m].lanes)):
                ...
                jsArray = jsArray + "['read1ClusterDensity','" + str(
                    expts[l].seqProjs[m].lanes[n].read1ClusterDensity) + "'],"
                ...
                for o in range(0, len(i.seqProjs[m].lanes[n].samples)):
                    ...
                    jsArray = jsArray + "['sampleName','" + str(
                        expts[l].seqProjs[m].lanes[n].samples[o].sampleName) + "'],"
                    jsArray = jsArray + "['tagID','" + str(expts[l].seqProjs[m].lanes[n].samples[o].tagID) + "'],"
                    jsArray = jsArray + "['tagSequence','" + str(
                        expts[l].seqProjs[m].lanes[n].samples[o].tagSequence) + "'],"
                    jsArray = jsArray + "['analysisID','" + str(
                        expts[l].seqProjs[m].lanes[n].samples[o].analysisID) + "'],"
                    jsArray = jsArray + "['adaptorSequence','" + str(
                        expts[l].seqProjs[m].lanes[n].samples[o].adaptorSequence) + "']"
                    jsArray = jsArray + "],"
