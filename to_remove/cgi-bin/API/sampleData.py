...
class sampleData:
    ...
    def getSampleDataByID(self, sampleID):
        ...
        DBquery = "select sampleName, tagID, laneID, tagSequence, analysisID, adaptorSequence, tagKit from sampleData where sampleID=" + str(
            sampleID)
    ...
    def insertSample(self):
        ...
        vals = " VALUES( '" + self.sampleName + "'," + str(self.tagID) + "," + str(self.laneID) + ",'" + str(
            self.tagSequence) + "'," + str(self.analysisID) + ",'" + self.adaptorSequence + "','" + self.tagKit + "')"
    ...
    def updateDB(self):
        ...
        updateQuery = "UPDATE sampleData SET sampleName='" + str(self.sampleName) + "', laneID=" + str(
            self.laneID) + ", tagID=" + str(self.tagID) + ", tagSequence='" + str(
            self.tagSequence) + "', analysisID=" + str(self.analysisID) + ", adaptorSequence='" + str(
            self.adaptorSequence) + "', tagKit='" + str(self.tagKit) + "' where sampleID=" + str(self.sampleID)
        # print updateQuery
