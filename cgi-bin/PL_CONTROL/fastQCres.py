...
class fastQCres:
		...
		self.QCtables={'Basic Statistics':[], 'Per base sequence quality':[], 'Per sequence quality scores':[], 'Per base sequence content':[], 'Per base GC content':[], 'Per sequence GC content':[],  'Per base N content':[], 'Sequence Length Distribution':[], 'Sequence Duplication Levels':[], 'Overrepresented sequences':[], 'Kmer Content':[]}
	...
	def lines2tableFormat(self,currentKey,tableLines):
		...
		if currentKey=="Per base sequence quality":
			header=["BaseStart",",BaseEnd","Mean","Median","Lower_Quartile","Upper_Quartile","10th_Percentile","90th_Percentile"]
