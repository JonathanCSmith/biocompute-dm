...
if os.path.islink(dataSourcePATH):
    print
    "Data source directory is a symbolic link. Aborting"
    print
    "(This probably means the data have already been moved to the sftp area)"
...
if os.path.islink(qcSourcePATH):
    print
    "QC source directory is a symbolic link. Aborting"
    print
    "(This probably means the QC stats have already been moved to the sftp area)"
