...
print '<p><a href="/cgi-bin/coreInSys/createMasterProjectLink?projID='+i.masterProjectID+'">Create Master Project Link</a></p>'
print '</td></tr>'
...
print '<p><a href="/cgi-bin/coreInSys/upLoadDoc?masterProjID='+projectID+'">Upload a document</a></p>'
print '</td></tr>'
...
for dispDocs in range(0,len(i.documents)):
	projNum="%05g" %(int(i.masterProjectID))
        projDir="/CoreInSys/Projects/"+projNum+"_"+i.projectName+"/Documents"
	...
	print '<td><a href="/cgi-bin/coreInSys/removeMastProjDoc?masterProjID='+str(i.masterProjectID)+'&documentID='+str(i.documents[dispDocs][0])+'">Delete Document</a></td>'
	print '</tr>'
