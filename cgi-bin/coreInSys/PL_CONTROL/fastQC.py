...
class fastQC:
	...
	def updateDBentry(self):
		...
		DBquery="update fastQC set location='"+self.currentOutDirName+"' , sourceLocation='"+self.currentSamplePath+"', JID="+self.currentJID+", status='running' where sampleID="+str(self.currentSample.sampleID)
