...
class laneData:
    ...
    def updateDB(self):
        ...
        updateQuery = "UPDATE laneData SET laneNumber='" + str(self.laneNumber) + "', seqProjectID=" + str(
            self.seqProjectID) + ", sequencingConc='" + str(self.sequencingConc) + "', read1ClusterDensity=" + str(
            self.read1ClusterDensity) + ", PhiXspiked='" + str(self.PhiXspiked) + "', spike='" + str(
            self.spike) + "', spikeRatio=" + str(self.spikeRatio) + " where laneID=" + str(self.laneID)
        # print updateQuery
    ...
    def getLaneDataByID(self, laneID):
        ...
        DBquery = "select laneNumber, seqProjectID, sequencingConc, read1ClusterDensity, PhiXspiked, spike, spikeRatio from laneData where laneID=" + str(
            laneID)
    ...
    def insertLane(self):
        ...
        vals = " VALUES('" + str(self.seqProjectID) + "'," + str(self.laneNumber) + "," + str(
            self.sequencingConc) + ",'" + str(self.read1ClusterDensity) + "'," + str(self.PhiXspiked) + ",'" + str(
            self.spike) + "'," + str(self.spikeRatio) + ")"
