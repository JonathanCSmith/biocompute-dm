...
function experimentTable(exptArr)
	...
	//
        function addSample(laneNo)
                {
                var frm=document.getElementById("newSeqExpt");
                frm.action="/cgi-bin/coreInSys/addSample";
	...
	function remSample(sampNo)
                {
                var frm=document.getElementById("newSeqExpt");
                frm.action="/cgi-bin/coreInSys/remSample";
	...
	function makeLaneCell0(exptArr,ex,pr,la,lastLane)
		...
		for (var laData=0;laData<exptArr[ex][1][pr][1][la][0].length;laData++)
			{
       			...
       			if (exptArr[ex][1][pr][1][la][0][laData][0]=="laneNumber") 
				{
                                da.style.color="#ff0000";
                        	}
		...
		if (exptArr[ex][1][pr][1].length>1)
			...
			var rw1=document.createElement("tr");
                        ...
                        remLaneButton.addEventListener('click',function() {remLane(this.id);}, false);
	...
	function addLane(projNo)
		...
		frm.action="/cgi-bin/coreInSys/addLane";
	...
	function remLane(laneNo)
                {
                var frm=document.getElementById("newSeqExpt");
                frm.action="/cgi-bin/coreInSys/remLane";
	...
	function addSeqProj()
		{
		var frm=document.getElementById("newSeqExpt");
		frm.action="/cgi-bin/coreInSys/addSeqPro";		
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        function remSeqProj(projNo)
                {
                var frm=document.getElementById("newSeqExpt");
                frm.action="/cgi-bin/coreInSys/remSeqProj";
	...
	function makeProjectCell0(exptArr,ex,pr,lastProj)
		...
		var projCell0=document.createElement("td");
			...
			if (exptArr[ex][1][pr][0][prData][0]=="seqProjectName")
				{
				da.style.color="#ff0000";
				}
                        da.appendChild(cellText);
